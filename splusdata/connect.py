...
class connect:
    ...
    def twelve_band_img(
        ...
        res = requests.get(
            "https://splus.cloud/api/get_image/"
            + str(ra)
            + "/"
            + str(dec)
            + "/"
        ...
        source["filename"]
        res = requests.get(
            "https://splus.cloud" + source["filename"], headers=self.headers
        )
    ...
    def get_img(self, ra, dec, radius, R="I", G="R", B="G", stretch=3, Q=8, option=1):
        ...
        """
        res = requests.get(
            "https://splus.cloud/api/get_lupton_image/"
            + str(ra)
            + "/"
            + str(dec)
            + "/"
    ...
    def get_band_img(self, ra, dec, radius, band="R", mode="linear", option=1):
        ...
        """
        res = requests.get(
            "https://splus.cloud/api/get_band_image/"
            + str(ra)
            + "/"
            + str(dec)
            + "/"
    ...
    def get_cut(self, ra, dec, radius, band, filepath=None, option=1):
        ...
        if band.upper() == "ALL":
            if filepath == None:
                ...
                res = requests.get(
                    "https://splus.cloud/api/get_direct_cut/"
                    + str(ra)
                    + "/"
                    + str(dec)
                    + "/"
    ...
    def get_cut_weight(self, ra, dec, radius, band, filepath=None, option=1):
        ...
        if band.upper() == "ALL":
            if filepath == None:
                ...
                filepath = filepath + ".tar.gz"
                res = requests.get(
                    "https://splus.cloud/api/get_direct_cut_weight/"
                    + str(ra)
                    + "/"
                    + str(dec)
                    + "/"
    ...
    def get_field(self, field, band):
        ...
        """
        res = requests.get(
            "https://splus.cloud/api/get_direct_field/" + str(field) + "/" + str(band),
            headers=self.headers,
        )
        hdu = fits.open(io.BytesIO(res.content))
    ...
    def get_field_weight(self, field, band):
        ...
        """
        res = requests.get(
            "https://splus.cloud/api/get_direct_field_weight/"
            + str(field)
            + "/"
            + str(band),
            headers=self.headers,
    ...
    def query(self, query, table_upload=None, publicdata=None):
        ...
        try:
            ...
            if process == "COMPLETED":
                ...
                link = (
                    link.replace("http://192.168.10.23:8080", "https://splus.cloud")
                    .replace("http://10.180.0.209:8080", "https://splus.cloud")
                    .replace("http://10.180.0.207:8080", "https://splus.cloud")
                    .replace("http://10.180.0.219:8080", "https://splus.cloud")
                )
    ...
    def checkcoords(self, ra, dec):
        ...
        """
        res = requests.get(
            "https://splus.cloud/api/whichdr/" + str(ra) + "/" + str(dec),
            headers=self.headers,
        )
